class CloudSnapshotsController < ApplicationController
    ...
    def index
        ...
        @snapshots = CloudSnapshot.search_by_user(current_user, options)
	...
	def update
		...
		respond_to do |format|
			if @cloud_resource.update_attributes(params[:cloud_snapshot])
