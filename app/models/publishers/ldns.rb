...
class Publishers::Ldns < Publisher
    ...
    def publish!
        ...
        begin
            ...
            hostfile = intro + DNS_Adapter.get_host_entries(provider_account).join
            ...
            provider_hosts_url = s3_url_for(bucket, provider_path)
			account.set_provider_account_parameter(URL_PARAM_NAME , provider_hosts_url, true)
