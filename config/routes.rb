...
#    map.associate_instance_address '/instances/:id/associate_address', :controller => 'instances', :action => 'associate_address'
	...
	map.resources :in_messages, :controller => 'in_messages', :collection => { :list => :any }
	map.resources :out_messages, :controller => 'out_messages', :collection => { :list => :any }
